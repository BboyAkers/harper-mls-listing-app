...
function ToggleGroup({
	...
	return (
		<ToggleGroupPrimitive.Root
			...
			data-size={size}
			className={cn('group/toggle-group flex w-fit items-center rounded-md gap-1', className)}
			{...props}
		>
